...
import static frontend.clang.ClangErrorCode.INVALID_NUMBER;

import frontend.Source;
import frontend.clang.ClangToken;

/**
 * <h1>ClangNumberToken</h1>
 * <p>
 * <p>C language number tokens(integer and real)</p>
 */
public class ClangNumberToken extends ClangToken {
   ...
   */
  public ClangNumberToken(Source source) throws Exception {
    super(source);
  }
